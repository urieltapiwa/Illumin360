...
builder.Services.AddScoped<Illumin360.EmployerWeb.Services.KeycloakRegistrar>();
builder.Services.AddTransient<Illumin360.EmployerWeb.Services.TokenRelayHandler>();

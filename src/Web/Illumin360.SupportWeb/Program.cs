...
builder.Services.AddTransient<Illumin360.SupportWeb.Services.TokenRelayHandler>();
builder.Services.AddHttpClient<Illumin360.SupportWeb.Services.SupportApiClient>(client =>
        client.BaseAddress = new Uri(builder.Configuration["Gateway:BaseAddress"] ?? "http://localhost:8088"))
    .AddHttpMessageHandler<Illumin360.SupportWeb.Services.TokenRelayHandler>();

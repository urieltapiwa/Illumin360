...
/// service expects: realm roles under a <c>realm_access</c> JSON claim. The tests reconfigure JWT
/// bearer to trust <see cref="SigningKey"/>.
/// </summary>
public static class TestToken
{
    ...
    public static string ForRoles(string[] roles, string username = "dev.admin")
    {
